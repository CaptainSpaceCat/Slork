...
GameTrak gt;
// =============================================== Main Loop ==============================================
me.dir() + "/resources/mixkit-bird-chirps.wav" => string filename;
...
fun void blip(int chan) {
    [31567, 61546, 97680] @=> int chirp_starts[];
    pit => adsrs[chan];
    chirp_starts[Math.random2(0, chirp_starts.cap()-1)] => buf.pos;
    adsrs[chan].keyOn();
    Math.random2(1, 3)*40::ms => now;
    adsrs[chan].keyOff();
    10::ms => now;
    pit =< adsrs[chan];
}
